...
namespace VanyaGame.GameCardsEasyDB.Struct
{
    ...
    /// </summary>
    public class CardsEasyDBLevel : Level
    {
        private DBModel.Level DbLevelRecord;

        public CardsEasyDBLevel(string _LevelDir = @"\Level1") : base()
        {
        ...
        public CardsEasyDBLevel(DBModel.Level DbLevelRecord) : base()
        {
        ...
        public static void LoadLevels(DBmainTools DB)
        {
            ...
            {
                Level NewLevel = new CardsEasyDBLevel(level);
        ...
        public static void LoadSetsFromDBRecord(CardsEasyDBLevel Level)
        {
            Level.Scenes.Clear();
            ...
            {
                Scene NewScene = new CardsEasyDBScene(Level, Scene, "Scene" + Scene.Id.ToString());
