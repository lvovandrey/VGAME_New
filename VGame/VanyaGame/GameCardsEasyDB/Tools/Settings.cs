    ...
    public static class Settings
    {
        ...
        public static double SlowRate
        {
            ...
            set
            {
                ...
                {
                    InfoWindow.Show("Скорость воспроизведения должна быть положительным числом от 0.001 до 100");
                    return;
                }
        ...
        public static double RateShift
        {
            ...
            set
            {
                if (value <= 0 || value > 100)
                {
                    InfoWindow.Show("Шаг скорости воспроизведения должна быть положительным числом от 0.001 до 100");
                    return;
                }
        ...
        public static double Step
        {
            ...
            set
            {
                ...
                {
                    InfoWindow.Show("Шаг перемещения задается в милисекундах от 1 (1 мсек) до 3 600 000 (1 час)");
                    return;
                }
                step = value.ToString();
            }
        ...
        public static double DefaultVolume
        {
            ...
            set
            {
                if (value < 0 || value > 100)
                {
                    InfoWindow.Show("Громкость по умолчанию - параметр задается в пределах от 0 до 100");
                    return;
                }
